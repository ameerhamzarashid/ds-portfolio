...
export default function DataWorld() {
  ...
  return (
    <section id="data-world" className="relative overflow-hidden px-5 py-20 md:py-28">
      <div className="absolute left-[-220px] top-20 h-[420px] w-[420px] rounded-full bg-orange-500/10 blur-3xl md:h-[520px] md:w-[520px]" />
      <div className="absolute bottom-20 right-[-240px] h-[420px] w-[420px] rounded-full bg-amber-500/10 blur-3xl md:h-[560px] md:w-[560px]" />
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <ScrollReveal>
            <div className="glass-card relative overflow-hidden rounded-[2rem] p-5 md:min-h-[620px] md:rounded-[2.5rem] md:p-8">
              ...
              <div className="relative z-10 md:hidden">
                <div className="mb-5 rounded-[2rem] border border-orange-200/15 bg-black/60 p-5 text-center">
                  <p className="text-xs font-black uppercase tracking-[0.3em] text-orange-300">
                    Data World
                  </p>
                  <h3 className="mt-3 text-4xl font-black text-orange-50">AI</h3>
                  <p className="mt-3 text-sm font-semibold text-stone-400">
                    Tap a node below to explore the map.
                  </p>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-2xl border p-4 text-left transition ${
                          isSelected
                            ? "border-amber-300/60 bg-orange-500/25"
                            : "border-orange-200/15 bg-black/45"
                        }`}
                      >
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-300">
                          {node.type}
                        </p>
                        <p className="mt-2 text-sm font-black text-orange-50">
                          {node.label}
                        </p>
                      </button>
                    );
          ...
          <ScrollReveal delay={0.08}>
            <div className="deep-glass rounded-[2rem] p-6 md:sticky md:top-28 md:rounded-[2.5rem] md:p-8">
              <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.3em] text-orange-300">
                    Selected Node
                  </p>
                  <h3 className="mt-3 text-3xl font-black text-orange-50 md:text-4xl">
                    {selectedNode.label}
                  </h3>
                </div>

                <span className="w-fit rounded-full border border-orange-300/20 bg-orange-500/10 px-4 py-2 text-xs font-bold text-orange-200">
                  {selectedNode.type}
                </span>
              </div>

              <p className="text-base font-semibold leading-8 text-stone-300 md:text-lg">
                {selectedNode.short}
              </p>

              <p className="mt-5 text-sm leading-7 text-stone-400 md:text-base md:leading-8">
