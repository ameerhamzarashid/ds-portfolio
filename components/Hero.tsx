        ...
        >
          ...
          <h1 className="text-5xl font-extrabold leading-tight text-white md:text-7xl">
            ...
            <span className="block gradient-text">
              builds intelligent data systems.
            </span>
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            I design machine learning models, analytics dashboards, MLOps
            workflows and applied AI systems that turn complex data into clear
            decisions.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              ...
              download
              className="rounded-full border border-cyan-300/40 px-6 py-3 font-semibold text-cyan-200 transition hover:bg-cyan-300 hover:text-slate-950"
            >
              Download CV
            </a>
